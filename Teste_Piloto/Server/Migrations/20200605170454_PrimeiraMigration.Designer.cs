...
namespace Teste_Piloto.Server.Migrations
{
    ...
    [Migration("20200605170454_PrimeiraMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faculdade_FUP_Project.Server.Models.Email", b =>
                {
            ...
            modelBuilder.Entity("Faculdade_FUP_Project.Server.Models.Telefone", b =>
                {
            ...
            modelBuilder.Entity("Faculdade_FUP_Project.Server.Models.Email", b =>
                {
                    b.HasOne("Faculdade_FUP_Project.Server.Models.Aluno", "Aluno")
                        .WithOne("Email")
                        .HasForeignKey("Faculdade_FUP_Project.Server.Models.Email", "AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Faculdade_FUP_Project.Server.Models.Chefia", "Chefia")
                        .WithOne("Email")
                        .HasForeignKey("Faculdade_FUP_Project.Server.Models.Email", "ChefiaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Faculdade_FUP_Project.Server.Models.Funcionario", "Funcionario")
                        .WithOne("Email")
                        .HasForeignKey("Faculdade_FUP_Project.Server.Models.Email", "FuncionarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Faculdade_FUP_Project.Server.Models.Telefone", b =>
                {
                    b.HasOne("Faculdade_FUP_Project.Server.Models.Aluno", "Aluno")
                        .WithOne("Telefone")
                        .HasForeignKey("Faculdade_FUP_Project.Server.Models.Telefone", "AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Faculdade_FUP_Project.Server.Models.Funcionario", "Funcionario")
                        .WithOne("Telefone")
                        .HasForeignKey("Faculdade_FUP_Project.Server.Models.Telefone", "FuncionarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Faculdade_FUP_Project.Server.Models.Chefia", "Chefia")
                        .WithOne("Telefone")
                        .HasForeignKey("Faculdade_FUP_Project.Server.Models.Telefone", "Telefone");
                });
